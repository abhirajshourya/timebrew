...
const WavyRings = ({ children, rings, width, delay, isRunning }: WavyRingsProps) => {
    ...
    return (<>
        <View style={styles.container} >
            ...
            <View style={[styles.circle, { width: width, height: width }, styles.noOverlap]} >
            </View>
...
const Ring = ({ delay, width, isRunning }: RingProps) => {
    ...
    return <Animated.View style={[styles.ring, { width: width, height: width, position: "absolute" }, circleStyle]} />
